...
a custom db timeout with every SQL.
(https://airflow.apache.org/docs/apache-airflow-providers-postgres/5.0.0/operators/postgres_operator_howto_guide.html#passing-server-configuration-parameters-into-postgresoperator)
