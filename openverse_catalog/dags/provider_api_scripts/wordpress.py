...
# TODO: Update HOST, ENDPOINT and CDN when the actual API is ready
HOST = "photodir.zack.cat"
ENDPOINT = f"https://{HOST}/api/wp-json/wp/v2/photos"
CDN = "https://photodir.zack.cat/cdn/2021/05/"
...
def _extract_item_data(media_data):
    ...
    try:
        foreign_landing_url = f'https://{HOST}/photos/photo/{media_data["slug"]}'
...
def _get_image_info(media_data):
    # TODO: Add correct implementation of _get_image_info
    height = media_data.get("height")
    width = media_data.get("width")
    image_url = media_data.get("_links", {}).get("self", {}).get("href")
    return image_url, height, width


def _get_thumbnail_url(media_data):
    # TODO: Add correct implementation of _get_thumbnail_url
    return media_data.get("thumbnail", {}).get("url")
