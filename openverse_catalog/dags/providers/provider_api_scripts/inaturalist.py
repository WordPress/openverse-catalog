...
from common.licenses import get_license_info, get_license_info_from_license_pair
...
API_KEY = os.getenv("INATURALIST", "nokeyprovided")
...
def check_and_save_json_for_test(name, data):
    ...
    test_resources_path = parent / 'tests' / 'resources' / 'inaturalist'
...
def main():
    """
    This script pulls the data for a given date from the Inaturalist,
