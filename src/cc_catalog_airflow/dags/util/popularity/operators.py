...
def drop_media_popularity_relations(dag, postgres_conn_id, media_type='image'):
...
def drop_media_popularity_functions(dag, postgres_conn_id, media_type='image'):
    return PythonOperator(
...
def create_media_popularity_metrics(dag, postgres_conn_id, media_type='image'):
    return PythonOperator(
...
def update_media_popularity_metrics(dag, postgres_conn_id, media_type='image'):
    return PythonOperator(
...
def create_media_popularity_percentile(dag, postgres_conn_id, media_type='image'):
    return PythonOperator(
...
def create_media_popularity_constants(dag, postgres_conn_id, media_type='image'):
    return PythonOperator(
...
def update_media_popularity_constants(dag, postgres_conn_id, media_type='image'):
    return PythonOperator(
...
def create_media_standardized_popularity(dag, postgres_conn_id, media_type='image'):
    return PythonOperator(
