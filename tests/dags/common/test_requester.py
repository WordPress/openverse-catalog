...
from tests.dags.conftest import FAKE_OAUTH_PROVIDER
...
def test_oauth_requester_initializes_correctly(oauth_provider_vars):
    odq = requester.OAuth2DelayedRequester(FAKE_OAUTH_PROVIDER, 1)
